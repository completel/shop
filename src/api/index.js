...
// 注册
// URL: /api/user/passport/register method: post phone code password method: post
...
export const reqUsrOrderList = (page, limit) => requests({ url: `/order/auth/${page}/${limit}`, method: 'GET' });